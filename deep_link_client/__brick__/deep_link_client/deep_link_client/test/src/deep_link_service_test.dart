...
import 'package:deep_link_client/src/deep_link_service.dart';
...
void main() {
  ...
  group('DeepLinkService', () {
    ...
    group('dispose', () {
      test('closes the deepLinkSubject stream', () async {
        final deepLinkService = DeepLinkService(deepLinkClient: deepLinkClient);
        expect(deepLinkService.deepLinkSubject.isClosed, isFalse);
        expect(deepLinkService.deepLinkSubscription, isNotNull);

        await deepLinkService.dispose();

        expect(deepLinkService.deepLinkSubject.isClosed, isTrue);
        expect(deepLinkService.deepLinkSubscription, isNull);
      });
    });
  });
