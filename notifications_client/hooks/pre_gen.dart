...
import 'package:notifications_client_hooks/src/models/models.dart';

void run(HookContext context) {
  final configuration =
      NotificationsClientConfiguration.fromHookVars(context.vars);
  ...
  context.vars = {
    ...
    'should_generate_appmetrica_client':
        configuration.shouldGenerateAppMetricaClient,
  };
}
